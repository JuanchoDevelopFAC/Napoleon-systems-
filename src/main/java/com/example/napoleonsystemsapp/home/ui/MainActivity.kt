...
import com.example.napoleonsystemsapp.home.viewmodel.HomeViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vm.postModelListLiveData?.observe(this, Observer {
            if(it!=null) {
                ...
                Toast.makeText(this, "Algo ha ocurrido", Toast.LENGTH_SHORT).show()
            }
            ...
            if(title.isNotEmpty() && body.isNotEmpty()) {
                ...
                vm.createPostLiveData?.observe(this, Observer {
                    if(it!=null) {
                        ...
                        Toast.makeText(this, "No se pudo crear el post", Toast.LENGTH_SHORT).show()
                    }
                    dialog.cancel()
                })
            } else {
    ...
    override fun onItemDeleted(postModel: PostModel, position: Int) {
        ...
        vm.deletePostLiveData?.observe(this, Observer {
            if(it!=null) {
                ...
                Toast.makeText(this, "No se ha podido eliminar el post", Toast.LENGTH_SHORT).show()
            }
        })
    }
}